            ...
            <table className="w-full table-auto">
              <thead className="bg-netral-15 text-body-sm font-semibold uppercase">
                <tr>
                  ...
                  <th className="whitespace-nowrap px-3 py-4 text-left text-netral-50 first:pl-5 last:pr-5">
                    <span className="text-body-sm font-semibold">User ID</span>
                  </th>
                  <th className="whitespace-nowrap px-3 py-4 text-left text-netral-50 first:pl-5 last:pr-5">
                    <span className="text-body-sm font-semibold">Email</span>
                  </th>
                  <th className="whitespace-nowrap px-3 py-4 text-left text-netral-50 first:pl-5 last:pr-5">
                    <span className="text-body-sm font-semibold">Phone</span>
                  </th>
                  <th className="whitespace-nowrap px-3 py-4 text-left text-netral-50 first:pl-5 last:pr-5">
                    <span className="text-body-sm font-semibold">Coins</span>
                  </th>
                  <th className="whitespace-nowrap px-3 py-4 text-left text-netral-50 first:pl-5 last:pr-5">
                    <span className="text-body-sm font-semibold">Diamonds</span>
                  </th>
                  <th className="whitespace-nowrap px-3 py-4 text-left text-netral-50 first:pl-5 last:pr-5">
                    <span className="text-body-sm font-semibold">Beans</span>
                  </th>
                  <th className="whitespace-nowrap px-3 py-4 text-left text-netral-50 first:pl-5 last:pr-5">
